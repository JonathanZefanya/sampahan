...
class ProfileController extends BaseController
{
    public function index(): string
    {
        ...
        return $this->render('layouts/dinas', 'dinas/profile', ['user' => $user]);
    }
    ...
    public function update()
    {
        ...
        if ($update === 'info') {
            ...
            return redirect()->to('/dinas/profile')->with('success', 'Profil diperbarui.');
        }
        ...
        if ($update === 'password') {
            ...
            return redirect()->to('/dinas/profile')->with('success', 'Password berhasil diubah.');
        }

        return redirect()->to('/dinas/profile');
    }
}
