  ...
  <div class="col-12 col-md-4 col-lg-3">
    <div class="card border-0 shadow-sm text-center">
      <div class="card-body d-flex flex-column align-items-center py-4">
        ...
        <span class="badge bg-primary mb-3">Masyarakat</span>
        <hr class="w-100 my-2">
        <div class="w-100 text-start">
          ...
          <div class="d-flex justify-content-between small text-muted mb-1">
            <span><i class="bi bi-file-earmark me-1"></i>Total Laporan</span>
            <span class="fw-semibold text-dark"><?= $total ?></span>
          </div>
          <div class="d-flex justify-content-between small text-muted">
            <span><i class="bi bi-check-circle me-1"></i>Selesai</span>
            <span class="fw-semibold text-success"><?= $cleaned ?></span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card border-0 shadow-sm">
      ...
      <div class="card-body p-4 tab-content">
        <div class="tab-pane fade show active" id="tabInfo">
          ...
          <?php endif; ?>
          <form action="<?= base_url('masyarakat/profile') ?>" method="POST">
            <?= csrf_field() ?>
