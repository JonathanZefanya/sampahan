...
$roleBadges = ['admin'=>['dark','Admin'],'dinas'=>['success','Dinas'],'masyarakat'=>['primary','Masyarakat']];
$rb = $roleBadges[$role] ?? ['secondary', ucfirst($role)];
?>
<div class="mb-4">
  ...
  <div class="col-12 col-md-4 col-lg-3">
    <div class="card border-0 shadow-sm text-center">
      <div class="card-body d-flex flex-column align-items-center py-4">
        ...
        <span class="badge bg-<?= $rb[0] ?> mb-3"><?= $rb[1] ?></span>
        <hr class="w-100 my-2">
            ...
            <div class="row g-3">
              <div class="col-12 col-sm-6">
                ...
                <input type="text" name="name" class="form-control"
                       value="<?= esc(old('name', $name)) ?>" required>
              </div>
              <div class="col-12 col-sm-6">
          ...
          <form action="<?= base_url('admin/profile') ?>" method="POST">
            ...
            <div class="mb-3">
              ...
              <div class="input-group">
                ...
                <button type="button" class="btn btn-outline-secondary"
                        onclick="togglePwd('pwdCurrent','iconCurrent')">
            ...
            <div class="mb-3">
              ...
              <div class="input-group">
                ...
                <button type="button" class="btn btn-outline-secondary"
                        onclick="togglePwd('pwdNew','iconNew')">
            ...
            <div class="mb-4">
              ...
              <div class="input-group">
                <input type="password" id="pwdConfirm" name="password_confirm" class="form-control"
                       placeholder="Ulangi password baru" minlength="8" required>
                <button type="button" class="btn btn-outline-secondary"
                        onclick="togglePwd('pwdConfirm','iconConfirm')">
